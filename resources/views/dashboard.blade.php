                ...
                <ul class="list-inline  text-center">
                  @forelse ($branch->sections  as $section)
                    <li style="font-size: 1.3em;" class="mb-2 list-inline-item font-weight-bold btn-sm alert-info">
                      <div class="badge badge-dark">{{$section->sections->get(0)->section_name}}</div>
                      <div class="badge badge-primary badge-pill">{{$section->branch_section_in_stock}}<br/>{{$section->branch_section_max_capicaty}}</div> 
                    </li>
                  @empty

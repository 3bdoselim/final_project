                        ...
                        @forelse ($employees as $employee)
                            <tr>
                                <td>
                                    ...
                                    <hr><small class="badge-primary badge">{{  $employee->manager_id ? $employee->managers->get(0)->employee_name : "None" }}</small>
                                </td>
                                <td>{{ $employee->employee_mobile }}</td>
                                <td>{{ $employee->employee_dob }}</td>
                                <td>{{ $employee->employee_hire_date }}</td>
                                <td>{{ $employee->employee_salary }}<hr/>{{ $employee->employee_commission }}</td>
                                <td>{{ $employee->jobs->get(0)->job_name }}</td>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-outline-primary" href="/employees/{{ $employee->id }}/edit">Edit</a>
                                </td>
                                <td>
